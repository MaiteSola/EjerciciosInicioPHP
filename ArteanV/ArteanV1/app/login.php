...
if (isset($_POST['user'])) {
    ...
    if ($user == "" || $pass == "")
        ...
        if ($user == "" || $pass == "") {
            ...
            //Ajusto credenciales
            $dsn = "mysql:host=localhost;dbname=artean;charset=utf8";
            $dbUser = "root";
            $dbPass = "";
            ...
            try {
                ...
                //Fetch assoc es que quiero el resultado como array asociativo (Es decir el id que es clave que sea el nobre de la columna)
